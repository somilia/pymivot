...
import os
import ssl
from pymivot.validator.mivot_validator.xml_validator import XMLValidator
from pymivot.validator.mivot_validator import logger
...
class AnnotatedVOTableValidator:
    ...
    vodml_validator = XMLValidator(
        ...
        "ModelInstanceInVot/master/tap_schema/xsd/mivot-v1.0.xsd"
    )
